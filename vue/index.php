...
$catalogue = $avionRepository->recupererAvions();
...
<div class="container mt-5">
    <div class="row d-flex justify-content-center">
        <?php foreach($catalogue as $avion){ ?>
            <div class="col-md-2 mb-4">
                <div class="card">
                    <img src="<?=$avion->recupererAvions()?>" class="card-img-top" alt="Affiche de <?=$avion->getNom()?>">
                    <div class="card-body text-center">
                        <h5 class="card-title"><?=$avion->getNom()?></h5>
                        <a href="vue/reservation.php?id_avion=<?=$Avion->getIdAvion()?>" class="btn btn-primary">Réserver</a>
                    </div>
                </div>
            </div>
        <?php } ?>
